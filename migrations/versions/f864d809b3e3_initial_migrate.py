...
Revision ID: f864d809b3e3
Revises: 
Create Date: 2024-04-30 23:58:08.468518
...
def upgrade():
    ...
    sa.Column('data_webhook', sa.DateTime(), nullable=False),
    sa.Column('acesso_curso', sa.Boolean(), nullable=True),
    sa.Column('mensagem_enviada', sa.Boolean(), nullable=True),
